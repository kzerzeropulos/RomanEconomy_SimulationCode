...
class AgentAdria(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type = "Adria"
        self.type_id = 0
        self.goods_list = [("AdriaticPottery", 1, 0)] * 10
        self.active = True
    ...
    def step(self):
        '''moves the agents to the neighboring node with the lowest travel cost among 3 random options'''
        if self.wealth <= 0:
            self.active = False
            return
        ...
        if self.wealth > 0:
            ...
            # Select up to 3 random neighboring nodes
            if neighbors:
                ...
                for node in potential_moves:
                    edge_weight = self.model.G.edges[self.pos, node]['weight']
                    if edge_weight < min_cost and self.wealth >= edge_weight:
                        min_cost = edge_weight
                        best_move = node

                # If a valid move is found, move the agent
                if best_move is not None:
                    self.last_traveled_edge_weight = min_cost
                    self.model.grid.move_agent(self, best_move)
                    self.wealth -= min_cost
...
class AgentAegean(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type = "Aegean"
        self.type_id = 1
        self.goods_list = [("AegeanPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentBaetica(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type = "Baetica"
        self.type_id = 2
        self.goods_list = [("BaeticanPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentEM(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type_id = 3
        self.goods_list = [("EMPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentEgypt(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type = "Egypt"
        self.type_id = 4
        self.goods_list = [("EgyptianPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentGallia(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type = "Gallia"
        self.type_id = 5
        self.goods_list = [("GallicPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentIberia(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type_id = 10
        self.goods_list = [("IberianPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentItaly(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type = "Italy"
        self.type_id = 6
        self.goods_list = [("ItalianPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentNA(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type_id = 7
        self.goods_list = [("NAPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentTarr(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type_id = 8
        self.goods_list = [("TarrPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
...
class AgentWM(mesa.Agent):
    def __init__(self, unique_id, model):
        ...
        self.type_id = 9
        self.goods_list = [("WMPottery", 1, 0)] * 10
        self.active = True
        self.agent_behavior = None
        self.trades_per_step = 0
        self.has_traded = False
