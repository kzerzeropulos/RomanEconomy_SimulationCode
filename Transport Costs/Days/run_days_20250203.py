...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_goods_behavior_nodiff_run_{run_number}_20250203.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_days_id_averages_20250203.csv'
    ...
    class_average_output_file = 'Runs/agents_days_class_averages_20250203.csv'
