from model_imperialism_20250214 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_imperialism_a_run_{run_number}_20250214.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_imperialism_a_id_averages_20250214.csv'
    ...
    class_average_output_file = 'Runs/agents_imperialism_a_class_averages_20250214.csv'
