from model_network_private_own_class_20250211 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_network_private_own_class_run_{run_number}_20250210.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_network_private_own_class_id_averages_20250211.csv'
    ...
    class_average_output_file = 'Runs/agents_network_private_own_class_class_averages_20250211.csv'
