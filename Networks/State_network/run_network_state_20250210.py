from model_network_state_20250210 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_network_state_run_{run_number}_20250210.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_network_state_id_averages_20250210.csv'
    ...
    class_average_output_file = 'Runs/agents_network_state_class_averages_20250210.csv'
