from model_network_private_extreme_transaction_20250211 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_goods_behavior_network_private_extreme_transaction_run_{run_number}_20250211.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_network_private_extreme_transaction_id_averages_20250211.csv'
    ...
    class_average_output_file = 'Runs/agents_network_private_extreme_transaction_class_averages_20250211.csv'
