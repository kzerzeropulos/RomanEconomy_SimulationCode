from model_days_customs_sameprice_20250207 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_goods_behavior_days_customs_sameprice_run_{run_number}_20250207.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_days_customs_sameprice_id_averages_20250207.csv'
    ...
    class_average_output_file = 'Runs/agents_days_customs_sameprice_class_averages_20250207.csv'
