from model_days_customs_histprice_20250210 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_goods_behavior_days_customs_histprice_run_{run_number}_20250210.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_days_customs_histprice_id_averages_20250210.csv'
    ...
    class_average_output_file = 'Runs/agents_days_customs_histprice_class_averages_20250210.csv'
