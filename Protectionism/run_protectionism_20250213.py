...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_protectionism_run_{run_number}_20250213.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_protectionism_id_averages_20250213.csv'
    ...
    class_average_output_file = 'Runs/agents_protectionism_class_averages_20250213.csv'
