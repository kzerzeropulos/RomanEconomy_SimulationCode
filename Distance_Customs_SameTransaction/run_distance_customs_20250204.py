from model_distance_customs_20250204 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_goods_behavior_distance_customs_run_{run_number}_20250204.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_distance_customs_id_averages_20250204.csv'
    ...
    class_average_output_file = 'Runs/agents_distance_customs_class_averages_20250204.csv'
