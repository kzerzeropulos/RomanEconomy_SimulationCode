...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_goods_customs_incoming_run_{run_number}_20250106_4.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_goods_customs_incoming_id_averages_20250106_4.csv'
    ...
    class_average_output_file = 'Runs/agents_goods_customs_incoming_class_averages_20250106_4.csv'
