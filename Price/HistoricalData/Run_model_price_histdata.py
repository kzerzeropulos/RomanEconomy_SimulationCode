from test_model_final_price_uneventrade_20241217 import TestModelINTEST
...
def run_model(run_number, fixed_agent_behaviors=None):
    ...
    output_filename = f'Runs/agents_goods_behavior_histdata_run_{run_number}_20250106.csv'
...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_goods_behavior_histdata_id_averages_20250106.csv'
    ...
    class_average_output_file = 'Runs/agents_goods_behavior_histdata_class_averages_20250106.csv'
