...
if all_dataframes:
    ...
    id_average_output_file = 'Runs/agents_goods_behavior_nodiff_id_averages_20250106.csv'
    ...
    class_average_output_file = 'Runs/agents_goods_behavior_nodiff_class_averages_20250106.csv'
